...
"Winners" view:
  ...
  Спасибо за проверку. В случае вопросов или несовпадения результатов пишите на почту или в дискорд или оставьте ваши данные, чтобы с вами была возможность связаться. Успехов в учебе.
